...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=NessStretch Demo Installer\n"
      else:
        line="OutputBaseFilename=NessStretch Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the NessStretch Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the NessStretch installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=NessStretch Demo installer\n"
     else:
       line="SetupWindowTitle=NessStretch installer\n"
