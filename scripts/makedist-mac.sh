...
NOTARIZE_BUNDLE_ID=com.BodhiSoft.NessStretch
NOTARIZE_BUNDLE_ID_DEMO=com.BodhiSoft.NessStretch.DEMO
...
#if [ $DEMO == 1 ]
#then
#  git checkout installer/NessStretch.iss
#  git checkout installer/NessStretch.pkgproj
